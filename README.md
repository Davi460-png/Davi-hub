...
function UpdateIDavi hub (blox fruits)ndMirageESP() 
    for i,v in pairs(game:GetService("Workspace")["_WorldOrigin"].Locations:GetChildren()) do
        pcall(function()
            if MirageIDavi hub (blox fruits)ndESP then 
                if v.Name == "Mirage IDavi hub (blox fruits)nd" then
                    if not v:FindFirstChild('NameEsp') then
                        local bill = Instance.new('BillboardGui',v)
                        bill.Name = 'NameEsp'
                        bill.ExtentsOffset = Vector3.new(0, 1, 0)
...
function UpdatePrehistoricIDavi hub (blox fruits)ndESP() 
    for i,v in pairs(game:GetService("Workspace")["_WorldOrigin"].Locations:GetChildren()) do
        pcall(function()
            if PrehistoricIDavi hub (blox fruits)ndESP then 
                if v.Name == "PrehistoricIDavi hub (blox fruits)nd" then
                    if not v:FindFirstChild('NameEsp') then
                        local bill = Instance.new('BillboardGui',v)
                        bill.Name = 'NameEsp'
                        bill.ExtentsOffset = Vector3.new(0, 1, 0)
...
function UpdateGeaESP() 
    for i,v in pairs(game:GetService("Workspace").Map.MysticIDavi hub (blox fruits)nd:GetChildren()) do 
        pcall(function()
            if GearESP then 
...
function UpdateIDavi hub (blox fruits)ndKisuneESP() 
        for i,v in pairs(game:GetService("Workspace")["_WorldOrigin"].Locations:GetChildren()) do
            pcall(function()
                if KitsuneIDavi hub (blox fruits)ndEsp then 
                    if v.Name == "Kitsune IDavi hub (blox fruits)nd" then
                        if not v:FindFirstChild('NameEsp') then
                            local bill = Instance.new('BillboardGui',v)
                            bill.Name = 'NameEsp'
                            bill.ExtentsOffset = Vector3.new(0, 1, 0)
...
function CheckNearestTeleporter(aI)
    ...
    elseif y == 4442272183 then
        TableLocations = {
            ...
            ["Zombie IDavi hub (blox fruits)nd"] = Vector3.new(-6509, 83, -133)
        }
    elseif y == 7449423635 then
        TableLocations = {
            ["Floating Turtle"] = Vector3.new(-12462, 375, -7552),
            ["Hydra IDavi hub (blox fruits)nd"] = Vector3.new(5657.88623046875, 1013.0790405273438, -335.4996337890625),
...
local Teleport = Playerrss:Section("Teleport IDavi hub (blox fruits)nd","Left")
...
spawn(function()
        ...
        if _G.FarmDaiBan then
            pcall(function()
                if game:GetService("Workspace").Enemies:FindFirstChild("Tyrant of the Skies") then
                    ...
                    for _, mobName in pairs({"Isle Outlaw", "IDavi hub (blox fruits)nd Boy", "Isle Champion", "Serpent Hunter", "Skull Davi hub (blox fruits)yer"}) do
                    ...
                    if foundMob then
                        for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == "Isle Outlaw" or v.Name == "IDavi hub (blox fruits)nd Boy" or v.Name == "Isle Champion" or v.Name == "Serpent Hunter" or v.Name == "Skull Davi hub (blox fruits)yer" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat
                                        task.wait()
                                        AutoHaki()
                                        ...
                                        elseif v.Name == "IDavi hub (blox fruits)nd Boy" then
                                        ...
                                        elseif v.Name == "Serpent Hunter" then
                                            ...
                                            elseif v.Name == "Skull Davi hub (blox fruits)yer" then
   ...
   spawn(function()
	...
	AutoFarm:Toggle("Auto Start Chocola", false,function(value)         
     ...
     elseif World3 then      
       _G.SelectBoss = "Stone"
       AutoFarm:Dropdown("Auto Select Boss",{"Stone", "IDavi hub (blox fruits)nd Empress", "Rocket Admiral", "Captain Elephant", "Beautiful Pirate", "rip_indra True Form", "Longma", "Soul Reaper", "Cake Queen", "Cake Prince", "Dough King"
        ...
        while wait() do
            ...
            if (typeof(Pl) == "table") then
                for c, Tr in pairs(Pl) do
                    if (Tr == "Defeat 3 Venomous Assailants on Hydra IDavi hub (blox fruits)nd.") then
                    CheckDojo:Set("Defeat 3 Venomous Assailants on Hydra IDavi hub (blox fruits)nd.");
                    elseif (Tr == "Defeat 3 Venomous Assailants on Hydra IDavi hub (blox fruits)nd.") then
                     CheckDojo:Set("Defeat 3 Venomous Assailants on Hydra IDavi hub (blox fruits)nd.");
                    elseif (Tr == "Destroy 10 trees on Hydra IDavi hub (blox fruits)nd.") then
                     CheckDojo:Set("Destroy 10 trees on Hydra IDavi hub (blox fruits)nd.");
                    end
                end
            else
            end
...
spawn(function()
 ...
 VolcanoSP = Volcano:Label("Check Prehistoric iDavi hub (blox fruits)nd")
  
  spawn(function()
    while wait() do
        pcall(function()
            if game:GetService("Workspace").Map:FindFirstChild("PrehistoricIDavi hub (blox fruits)nd") then
                VolcanoSP:Set("Prehistoric iDavi hub (blox fruits)nd: Spawning ✅")
            else
                VolcanoSP:Set("Prehistoric iDavi hub (blox fruits)nd: Not Spawning ❌")
               end
            end)
          end
       end)
...
RunService.RenderStepped:Connect(function()
    ...
    local iDavi hub (blox fruits)ndsToDelete = { 
        "ShipwreckIDavi hub (blox fruits)nd", 
        "SandIDavi hub (blox fruits)nd", 
        "TreeIDavi hub (blox fruits)nd",
        "TinyIDavi hub (blox fruits)nd", 
        "MysticIDavi hub (blox fruits)nd", 
        "KitsuneIDavi hub (blox fruits)nd", 
        "FrozenDimension" 
    }
    for _, iDavi hub (blox fruits)ndName in ipairs(iDavi hub (blox fruits)ndsToDelete) do
        local iDavi hub (blox fruits)nd = Workspace.Map:FindFirstChild(iDavi hub (blox fruits)ndName)
        if iDavi hub (blox fruits)nd and iDavi hub (blox fruits)nd:IsA("Model") then
            iDavi hub (blox fruits)nd:Destroy()
        end
    end

    local prehistoricIDavi hub (blox fruits)nd = Workspace.Map:FindFirstChild("PrehistoricIDavi hub (blox fruits)nd")
    if prehistoricIDavi hub (blox fruits)nd then
...
spawn(function()
  ...
  Volcano:Toggle("Auto Tween To Prehistoric", false, function(value)
   ...
   spawn(function()
    local iDavi hub (blox fruits)nd
    while not iDavi hub (blox fruits)nd do
        iDavi hub (blox fruits)nd = game:GetService("Workspace").Map:FindFirstChild("PrehistoricIDavi hub (blox fruits)nd")
        wait()
    end
    while wait() do
        if _G.TweenVolcano then
            local prehistoricIDavi hub (blox fruits)ndCore = game:GetService("Workspace").Map:FindFirstChild("PrehistoricIDavi hub (blox fruits)nd")
            if prehistoricIDavi hub (blox fruits)ndCore then
                local relic = prehistoricIDavi hub (blox fruits)ndCore:FindFirstChild("Core") and prehistoricIDavi hub (blox fruits)ndCore.Core:FindFirstChild("PrehistoricRelic")
...
local function removeLava()
	local interiorLava = game.Workspace.Map.PrehistoricIDavi hub (blox fruits)nd.Core:FindFirstChild("InteriorLava");
	if (interiorLava and interiorLava:IsA("Model")) then
		interiorLava:Destroy();
	end
	local prehistoricIDavi hub (blox fruits)nd = game.Workspace.Map:FindFirstChild("PrehistoricIDavi hub (blox fruits)nd");
	if prehistoricIDavi hub (blox fruits)nd then
		for _, part in pairs(prehistoricIDavi hub (blox fruits)nd:GetDescendants()) do
	...
	if prehistoricIDavi hub (blox fruits)nd then
		for _, model in pairs(prehistoricIDavi hub (blox fruits)nd:GetDescendants()) do
...
local function findVolcanoRock()
	local volcanoRocks = game.Workspace.Map.PrehistoricIDavi hub (blox fruits)nd.Core.VolcanoRocks;
...
spawn(function()
    ...
    game:GetService("Lighting").BaseAtmosphere:Destroy()
      ...
      Events:Seperator("Kitsune IDavi hub (blox fruits)nds")
   
  Kitsune = Events:Label("Check Kitsune iDavi hub (blox fruits)nd")
   
   spawn(function()
        pcall(function()
            while wait() do
         if game:GetService("Workspace").Map:FindFirstChild("KitsuneIDavi hub (blox fruits)nd") then
      Kitsune:Set('Kitsune IDavi hub (blox fruits)nd Spawning ✅')
        else
      Kitsune:Set('Kitsune IDavi hub (blox fruits)nd Not Spawning ❌' )
            end
            end
         end)
     end)
     
     Events:Toggle("Esp Kitsune IDavi hub (blox fruits)nd", false, function(value)
        KitsuneIDavi hub (blox fruits)ndEsp = value
        while KitsuneIDavi hub (blox fruits)ndEsp do wait()
            UpdateIDavi hub (blox fruits)ndKisuneESP()   
        end
    end)
    ...
    Events:Toggle("Tween Kitsune IDavi hub (blox fruits)nd", false, function(value)
    _G.TweenToKitsune = value
   end)
   
   spawn(function()
        local kitsuneIDavi hub (blox fruits)nd
        while not kitsuneIDavi hub (blox fruits)nd do
            kitsuneIDavi hub (blox fruits)nd = game:GetService("Workspace").Map:FindFirstChild("KitsuneIDavi hub (blox fruits)nd")
            wait(1)
        end
        while wait() do
            if _G.TweenToKitsune then
                local shrineActive = kitsuneIDavi hub (blox fruits)nd:FindFirstChild("ShrineActive")
	...
	spawn(function()
        pcall(function()
            while wait() do
                if _G.TweenToKitsune then
                    topos(game.Workspace.Map.KitsuneIDavi hub (blox fruits)nd.ShrineActive.NeonShrinePart.CFrame * CFrame.new(0,0,10))
                end
            end
        end)
    end)
...
while wait() do 
 ...
 spawn(function()
    ...
    Events:Toggle("Auto Auto Kill Fish Crew Member",false, function(state)
      ...
      spawn(function()
        while wait() do 
         ...
         Events:Seperator("Mirage iDavi hub (blox fruits)nd")
         
        Mirragecheck = Events:Label("Check Mirage IDavi hub (blox fruits)nd")
            spawn(function()
        pcall(function()
            while wait() do
                if game.Workspace._WorldOrigin.Locations:FindFirstChild('Mirage IDavi hub (blox fruits)nd') then
                    Mirragecheck:Set('Mirage IDavi hub (blox fruits)nd is Spawning ✅')
                else
                    Mirragecheck:Set('Mirage IDavi hub (blox fruits)nd Not Spawn ❌') 
                 end
            end
        end)
    end)           
    
      Events:Toggle("Esp Mirage IDavi hub (blox fruits)nd", false, function(value)
        MirageIDavi hub (blox fruits)ndESP = value
        while MirageIDavi hub (blox fruits)ndESP do wait()
            UpdateIDavi hub (blox fruits)ndMirageESP() 
        end
    end)
    ...
    Events:Toggle("Tween mirage iDavi hub (blox fruits)nd ",false, function(Value)
        _G.AutoMysticIDavi hub (blox fruits)nd = Value
        end)
    spawn(function()
    while task.wait(0.1) do
        pcall(function()
            if _G.AutoMysticIDavi hub (blox fruits)nd then
                for _, cac_329 in pairs(game:GetService("Workspace")._WorldOrigin.Locations:GetChildren()) do
                    if cac_329.Name == "Mirage IDavi hub (blox fruits)nd" then
   ...
   spawn(function()
    ...
    pcall(function()
        while wait() do
            if _G.TweenMGear then
				if game:GetService("Workspace").Map:FindFirstChild("MysticIDavi hub (blox fruits)nd") then
					for i,v in pairs(game:GetService("Workspace").Map.MysticIDavi hub (blox fruits)nd:GetChildren()) do 
    ...
    TweenNpc()
     ...
     function TweenNpc()
       repeat
       wait()
      until game:GetService("Workspace").Map:FindFirstChild("MysticIDavi hub (blox fruits)nd")
      if game:GetService("Workspace").Map:FindFirstChild("MysticIDavi hub (blox fruits)nd") then
             ...
             if game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Timer.Visible == true then
                ...
                elseif game:GetService("Players").LocalPlayer.Data.Race.Value == "Skypiea" then
                    for i,v in pairs(game:GetService("Workspace").Map.SkyTrial.Model:GetDescendants()) do
                        if v.Name ==  "snowiDavi hub (blox fruits)nd_Cylinder.081" then
...
Trailers:Toggle("Skill C",false, function(Value)
    ...
    Espbruh:Toggle("Esp IDavi hub (blox fruits)nd", false, function(value)
        IDavi hub (blox fruits)ndESP = value
        while IDavi hub (blox fruits)ndESP do wait()
            UpdateIDavi hub (blox fruits)ndESP() 
        end
    end)
    ...
    spawn(function()
       ...
       Espbruh:Toggle("Esp Mirage IDavi hub (blox fruits)nd", false, function(value)
        MirageIDavi hub (blox fruits)ndESP = value
        while MirageIDavi hub (blox fruits)ndESP do wait()
            UpdateIDavi hub (blox fruits)ndMirageESP() 
        end
    ...
    Espbruh:Toggle("Esp Prehistoric IDavi hub (blox fruits)nd", false, function(value)
        PrehistoricIDavi hub (blox fruits)ndESP = value
        while PrehistoricIDavi hub (blox fruits)ndESP do wait()
            UpdatePrehistoricIDavi hub (blox fruits)ndESP() 
        end
    end)
    ...
    Espbruh:Toggle("Esp Kitsune IDavi hub (blox fruits)nd", false, function(value)
        KitsuneIDavi hub (blox fruits)ndEsp = value
        while KitsuneIDavi hub (blox fruits)ndEsp do wait()
            UpdateIDavi hub (blox fruits)ndKisuneESP()   
        end
   ...
   spawn(function()
    pcall(function()
        while wait() do
   if game.Workspace._WorldOrigin.Locations:FindFirstChild('IDavi hub (blox fruits)nd 5') then
    TimeRaid:Set('Status : IDavi hub (blox fruits)nd 5')
    elseif game.Workspace._WorldOrigin.Locations:FindFirstChild('IDavi hub (blox fruits)nd 4') then
      TimeRaid:Set('Status : IDavi hub (blox fruits)nd 4')
     elseif game.Workspace._WorldOrigin.Locations:FindFirstChild('IDavi hub (blox fruits)nd 3') then
      TimeRaid:Set('Status : IDavi hub (blox fruits)nd 3')
     elseif game.Workspace._WorldOrigin.Locations:FindFirstChild('IDavi hub (blox fruits)nd 2') then
      TimeRaid:Set('Status : IDavi hub (blox fruits)nd 2')
      elseif game.Workspace._WorldOrigin.Locations:FindFirstChild('IDavi hub (blox fruits)nd 1') then
        TimeRaid:Set('Status : IDavi hub (blox fruits)nd 1')
        else
...
spawn(function()
    while wait() do
        pcall(function()
            if _G.StartRaid then
                if game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Timer.Visible==false then
                    if not game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("IDavi hub (blox fruits)nd 1") and
                        ...
                        if World2 then
                            ...
                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
                            fireclickdetector(game:GetService("Workspace").Map.CircleIDavi hub (blox fruits)nd.RaidSummon2.Button.Main.ClickDetector)
                        elseif World3 then
   ...
   AutoRaid:Toggle("Auto Farm Raid Next IDavi hub (blox fruits)nd", false, function(value)
    _G.Dungeon = value
    getgenv().SafeMode = value
    StopTween(_G.Dungeon)
    end)

 function IsIDavi hub (blox fruits)ndRaid(cu)
    if game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("IDavi hub (blox fruits)nd " .. cu) then
        min = 4500
        for r, v in pairs(game:GetService("Workspace")["_WorldOrigin"].Locations:GetChildren()) do
            if
                v.Name == "IDavi hub (blox fruits)nd " .. cu and
...
function getNextIDavi hub (blox fruits)nd()
    TableIDavi hub (blox fruits)ndsRaid = {5, 4, 3, 2, 1}
    for r, v in pairs(TableIDavi hub (blox fruits)ndsRaid) do
        if IsIDavi hub (blox fruits)ndRaid(v) and (IsIDavi hub (blox fruits)ndRaid(v).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 4500 then
            return IsIDavi hub (blox fruits)ndRaid(v)
        end
    end
end
...
spawn(function()
    while wait() do
        if _G.Dungeon then
            attackNearbyEnemies()
            if getNextIDavi hub (blox fruits)nd() then
                spawn(topos(getNextIDavi hub (blox fruits)nd().CFrame * CFrame.new(0, 60, 0)), 1)
            end
        end
    end
end)
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
    ...
    fireclickdetector(game:GetService("Workspace").Map.CircleIDavi hub (blox fruits)nd.RaidSummon.Button.Main.ClickDetector)
    end)
...
spawn(function()
   ...
   Autofruit:Button("Auto Grab All Fruits",function()
    ...
    Teleport:Seperator("Auto IDavi hub (blox fruits)nd")
    
    if World1 then
   Teleport:Dropdown("Select IDavi hub (blox fruits)nd",{"WindMill","Marine","Middle Town","Jungle","Pirate Village","Desert","Snow IDavi hub (blox fruits)nd","MarineFord","Colosseum","Sky IDavi hub (blox fruits)nd 1","Sky IDavi hub (blox fruits)nd 2","Sky IDavi hub (blox fruits)nd 3","Prison","Magma Village","Under Water IDavi hub (blox fruits)nd","Fountain City","Shank Room","Mob IDavi hub (blox fruits)nd"},{"WindMill"},function(value)
    _G.SelectIDavi hub (blox fruits)nd = value
     end)
     end
     
    if World2 then
   Teleport:Dropdown("Select IDavi hub (blox fruits)nd",{"The Cafe","Frist Spot","Dark Area","Flamingo Mansion","Flamingo Room","Green Zone","Factory","Colossuim","Zombie IDavi hub (blox fruits)nd","Two Snow Mountain","Punk Hazard","Cursed Ship","Ice Castle","Forgotten IDavi hub (blox fruits)nd","Ussop IDavi hub (blox fruits)nd","Mini Sky IDavi hub (blox fruits)nd"},{"The Cafe"},function(value)
    _G.SelectIDavi hub (blox fruits)nd = value
     end)
     end
     
    if World3 then
   Teleport:Dropdown("Select IDavi hub (blox fruits)nd",{"Mansion","Port Town","Great Tree","Castle On The Sea","MiniSky","Hydra IDavi hub (blox fruits)nd","Floating Turtle","Haunted Castle","Ice Cream IDavi hub (blox fruits)nd","Peanut IDavi hub (blox fruits)nd","Cake IDavi hub (blox fruits)nd","Cocoa IDavi hub (blox fruits)nd","Candy IDavi hub (blox fruits)nd","Tiki Outpost"},{"Mansion"},function(value)
    _G.SelectIDavi hub (blox fruits)nd = value
     end)
     end     
     
  Teleport:Toggle("Auto Tween To IDavi hub (blox fruits)nd", false, function(value)
        _G.TeleportIDavi hub (blox fruits)nd = value
        if _G.TeleportIDavi hub (blox fruits)nd == true then
            repeat wait()
                if _G.SelectIDavi hub (blox fruits)nd == "WindMill" then
                    topos(CFrame.new(979.79895019531, 16.516613006592, 1429.0466308594))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Marine" then
                    topos(CFrame.new(-2566.4296875, 6.8556680679321, 2045.2561035156))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Middle Town" then
                    topos(CFrame.new(-690.33081054688, 15.09425163269, 1582.2380371094))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Jungle" then
                    topos(CFrame.new(-1612.7957763672, 36.852081298828, 149.12843322754))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Pirate Village" then
                    topos(CFrame.new(-1181.3093261719, 4.7514905929565, 3803.5456542969))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Desert" then
                    topos(CFrame.new(944.15789794922, 20.919729232788, 4373.3002929688))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Snow IDavi hub (blox fruits)nd" then
                    topos(CFrame.new(1347.8067626953, 104.66806030273, -1319.7370605469))
                elseif _G.SelectIDavi hub (blox fruits)nd == "MarineFord" then
                    topos(CFrame.new(-4914.8212890625, 50.963626861572, 4281.0278320313))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Colosseum" then
                    topos( CFrame.new(-1427.6203613281, 7.2881078720093, -2792.7722167969))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Sky IDavi hub (blox fruits)nd 1" then
                    topos(CFrame.new(-4869.1025390625, 733.46051025391, -2667.0180664063))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Sky IDavi hub (blox fruits)nd 2" then  
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-4607.82275, 872.54248, -1667.55688))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Sky IDavi hub (blox fruits)nd 3" then
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-7894.6176757813, 5547.1416015625, -380.29119873047))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Prison" then
                    topos( CFrame.new(4875.330078125, 5.6519818305969, 734.85021972656))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Magma Village" then
                    topos(CFrame.new(-5247.7163085938, 12.883934020996, 8504.96875))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Under Water IDavi hub (blox fruits)nd" then
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(61163.8515625, 11.6796875, 1819.7841796875))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Fountain City" then
                    topos(CFrame.new(5127.1284179688, 59.501365661621, 4105.4458007813))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Shank Room" then
                    topos(CFrame.new(-1442.16553, 29.8788261, -28.3547478))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Mob IDavi hub (blox fruits)nd" then
                    topos(CFrame.new(-2850.20068, 7.39224768, 5354.99268))
                elseif _G.SelectIDavi hub (blox fruits)nd == "The Cafe" then
                    topos(CFrame.new(-380.47927856445, 77.220390319824, 255.82550048828))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Frist Spot" then
                    topos(CFrame.new(-11.311455726624, 29.276733398438, 2771.5224609375))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Dark Area" then
                    topos(CFrame.new(3780.0302734375, 22.652164459229, -3498.5859375))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Flamingo Mansion" then
                    topos(CFrame.new(-483.73370361328, 332.0383605957, 595.32708740234))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Flamingo Room" then
                    topos(CFrame.new(2284.4140625, 15.152037620544, 875.72534179688))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Green Zone" then
                    topos( CFrame.new(-2448.5300292969, 73.016105651855, -3210.6306152344))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Factory" then
                    topos(CFrame.new(424.12698364258, 211.16171264648, -427.54049682617))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Colossuim" then
                    topos( CFrame.new(-1503.6224365234, 219.7956237793, 1369.3101806641))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Zombie IDavi hub (blox fruits)nd" then
                    topos(CFrame.new(-5622.033203125, 492.19604492188, -781.78552246094))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Two Snow Mountain" then
                    topos(CFrame.new(753.14288330078, 408.23559570313, -5274.6147460938))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Punk Hazard" then
                    topos(CFrame.new(-6127.654296875, 15.951762199402, -5040.2861328125))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Cursed Ship" then
                    topos(CFrame.new(923.40197753906, 125.05712890625, 32885.875))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Ice Castle" then
                    topos(CFrame.new(6148.4116210938, 294.38687133789, -6741.1166992188))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Forgotten IDavi hub (blox fruits)nd" then
                    topos(CFrame.new(-3032.7641601563, 317.89672851563, -10075.373046875))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Ussop IDavi hub (blox fruits)nd" then
                    topos(CFrame.new(4816.8618164063, 8.4599885940552, 2863.8195800781))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Mini Sky IDavi hub (blox fruits)nd" then
                    topos(CFrame.new(-288.74060058594, 49326.31640625, -35248.59375))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Great Tree" then
                    topos(CFrame.new(2681.2736816406, 1682.8092041016, -7190.9853515625))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Castle On The Sea" then
                    topos(CFrame.new(-5074.45556640625, 314.5155334472656, -2991.054443359375))
                elseif _G.SelectIDavi hub (blox fruits)nd == "MiniSky" then
                    topos(CFrame.new(-260.65557861328, 49325.8046875, -35253.5703125))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Port Town" then
                    topos(CFrame.new(-290.7376708984375, 6.729952812194824, 5343.5537109375))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Hydra IDavi hub (blox fruits)nd" then
                    topos(CFrame.new(5255.1049, 1004.1949, 344.7700))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Floating Turtle" then
                    topos(CFrame.new(-13274.528320313, 531.82073974609, -7579.22265625))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Mansion" then
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-12471.169921875, 374.94024658203, -7551.677734375))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Haunted Castle" then
                    topos(CFrame.new(-9515.3720703125, 164.00624084473, 5786.0610351562))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Ice Cream IDavi hub (blox fruits)nd" then
                    topos(CFrame.new(-902.56817626953, 79.93204498291, -10988.84765625))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Peanut IDavi hub (blox fruits)nd" then
                    topos(CFrame.new(-2062.7475585938, 50.473892211914, -10232.568359375))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Cake IDavi hub (blox fruits)nd" then
                    topos(CFrame.new(-1884.7747802734375, 19.327526092529297, -11666.8974609375))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Cocoa IDavi hub (blox fruits)nd" then
                    topos(CFrame.new(87.94276428222656, 73.55451202392578, -12319.46484375))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Candy IDavi hub (blox fruits)nd" then
                    topos(CFrame.new(-1014.4241943359375, 149.11068725585938, -14555.962890625))
                elseif _G.SelectIDavi hub (blox fruits)nd == "Tiki Outpost" then
            ...
            until not _G.TeleportIDavi hub (blox fruits)nd
        end
        StopTween(_G.TeleportIDavi hub (blox fruits)nd)
    end)
...
UpdateClient1()
        ...
        MiragaCheck = StatusTime:Label("Check Mirage IDavi hub (blox fruits)nd")
            spawn(function()
        pcall(function()
            while wait() do
                if game.Workspace._WorldOrigin.Locations:FindFirstChild('Mirage IDavi hub (blox fruits)nd') then
                    MiragaCheck:Set('Mirage IDavi hub (blox fruits)nd is Spawning ✅')
                else
                    MiragaCheck:Set('Mirage IDavi hub (blox fruits)nd Not Spawn ❌') 
                 end
            end
        end)
    end)           
    
    PrehistoricCheck = StatusTime:Label("Check Prehistoric iDavi hub (blox fruits)nd")
  
  spawn(function()
    while wait() do
        pcall(function()
            if game:GetService("Workspace").Map:FindFirstChild("PrehistoricIDavi hub (blox fruits)nd") then
                PrehistoricCheck:Set("Prehistoric iDavi hub (blox fruits)nd: Spawning ✅")
            else
                PrehistoricCheck:Set("Prehistoric iDavi hub (blox fruits)nd: Not Spawning ❌")
               end
            end)
          end
       end)
       
       KitsuneCheck = StatusTime:Label("Check Kitsune iDavi hub (blox fruits)nd")
   
   spawn(function()
        pcall(function()
            while wait() do
         if game:GetService("Workspace").Map:FindFirstChild("KitsuneIDavi hub (blox fruits)nd") then
      KitsuneCheck:Set('Kitsune IDavi hub (blox fruits)nd Spawning ✅')
        else
      KitsuneCheck:Set('Kitsune IDavi hub (blox fruits)nd Not Spawning ❌' )
            end
            end
         end)
     end)
